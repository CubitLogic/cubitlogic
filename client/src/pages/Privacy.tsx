    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      <main className="container max-w-3xl mx-auto pt-28 pb-20">
        ...
        <div className="space-y-5 text-gray-600 leading-relaxed" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          ...
          <p>Cubit Logic collects only the information needed to operate the site, provide account access, process voluntary donations, deliver AI tutor features, and manage newsletter signups.</p>
          <p>Account information may include your name, email address, sign-in provider identifier, payment-provider reference IDs, and basic usage records such as daily AI tutor usage counts.</p>
