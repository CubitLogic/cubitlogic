...
import { Check, ChevronRight, Clock, Sparkles, Zap } from "lucide-react";
      ...
      <section className="py-16">
        <div className="container">
          ...
          <p
            ...
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
            All 7 modules are free and available to everyone.
          </p>
          ...
          <div className="space-y-3">
            {courseModules.map((mod) => {
              ...
              return (
                <div
                  key={mod.id}
                  className="rounded-2xl border border-gray-100 bg-white hover:border-gray-300 hover:shadow-sm cursor-pointer transition-all duration-200 overflow-hidden"
                >
